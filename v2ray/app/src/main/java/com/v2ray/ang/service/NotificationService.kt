...
object NotificationService {
    ...
    /**
     * Calls startForeground() immediately with a minimal notification.
     * Must be called early in onStartCommand() to avoid ForegroundServiceDidNotStartInTimeException.
     */
    fun startForegroundNow() {
        ...
        val notification = NotificationCompat.Builder(service, channelId)
            ...
            .setContentText(service.getString(R.string.connection_not_connected))
