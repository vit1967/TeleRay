...
object AngConfigManager {
    ...
    /**
     * Java-friendly wrapper for importBatchConfig that returns android.util.Pair.
     */
    @JvmStatic
    fun importBatchConfigJava(server: String?, subid: String, append: Boolean): android.util.Pair<Int, Int> {
        val result = importBatchConfig(server, subid, append)
        return android.util.Pair(result.first, result.second)
    }
