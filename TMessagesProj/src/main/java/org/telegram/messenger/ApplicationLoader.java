...
public class ApplicationLoader extends Application {
    ...
    public static void postInitApplication() {
        ...
        // Initialize V2Ray library and start service if needed
        try {
            org.telegram.messenger.V2RayBootstrap.ensureRunningBeforeAuthorization(applicationContext);
        } catch (Throwable e) {
            FileLog.e("Error initializing V2Ray", e);
        }
