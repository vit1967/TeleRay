...
//    public static int saveToGalleryFlags;
    ...
    public static long v2raySubscriptionId1 = 0L; // dialog/user ID of subscription1 bot
    ...
    public static long[] v2rayTimeLastRequestArray = new long[14];
    public static int v2rayRequestCount = 1; // Number of active requests (1-14)
    public static int timeBetwRequest2Bot    = 360; // min between v2ray key bot requests (ConfigSubscrBotRequest)
    public static int timeBetwRequest2BotMtp = 360; // min between MTProxy bot requests (ConfigMtpBotRequest)
    
    // V2Ray subscriptions
    public static String[] v2raySubscriptionBots = new String[5];
    public static long[] v2raySubscriptionBotIds = new long[5];
    public static String[][] v2rayRequestArrays = new String[5][14];
    public static String[][] v2rayKeyArrays = new String[5][14];
    public static long[][] v2rayTimeLastRequestArrays = new long[5][14];
    public static int[] v2rayRequestCounts = new int[5];
    public static int v2raySubscriptionsCount = 0;
    
    // Legacy fields for backward compatibility (mapped to array[0])
    public static String v2rayRequest1 = "";
    public static String v2rayKey1 = "";
    public static String v2rayRequest11 = "";
    public static String v2rayKey11 = "";
    public static String v2rayRequest12 = "";
    public static String v2rayKey12 = "";
    public static String v2rayRequest13 = "";
    public static String v2rayKey13 = "";
    
    static {
        // Initialize arrays with empty strings
        for (int i = 0; i < 14; i++) {
            v2rayRequest1Array[i] = "";
            v2rayKey1Array[i] = "";
            v2rayTimeLastRequestArray[i] = 0L;
        }
    }
    ...
    public static String v2rayMinWorkingKeys = "";

    // Auto connection test settings
    public static int autoMinWrkKeys = 1;
    public static int autoMinWrkMTProxy = 1;
    public static int autoTimeTstMinute = 5;

    // MTProxy subscriptions (channel-based)
    public static long[] mtproxySubscriptionChatIds = new long[5];
    public static String[][] mtproxyRequestArrays = new String[5][14];
    public static int[] mtproxyRequestCounts = new int[5];
    public static int mtproxySubscriptionsCount = 0;

    // MTProxy Bot subscriptions (bot-based, like v2ray bots but receive tg://proxy URLs)
    public static int mtpBotSubscriptionsCount = 0;
    public static String[] mtpBotSubscriptionBots = new String[5];
    public static long[] mtpBotSubscriptionBotIds = new long[5];
    public static int[] mtpBotRequestCounts = new int[5];
    public static String[][] mtpBotRequestArrays = new String[5][14];   // commands sent to bot
    public static String[][] mtpBotProxyArrays = new String[5][14];     // received proxy URLs
    public static long[][] mtpBotTimeLastRequestArrays = new long[5][14]; // timestamps

    static {
        for (int j = 0; j < 5; j++) {
            v2raySubscriptionBots[j] = "";
            v2raySubscriptionBotIds[j] = 0;
            v2rayRequestCounts[j] = 1;
            for (int i = 0; i < 14; i++) {
                v2rayRequestArrays[j][i] = "";
                v2rayKeyArrays[j][i] = "";
                v2rayTimeLastRequestArrays[j][i] = 0L;
            }

            mtproxySubscriptionChatIds[j] = 0;
            mtproxyRequestCounts[j] = 1;
            for (int i = 0; i < 14; i++) {
                mtproxyRequestArrays[j][i] = "";
            }

            mtpBotSubscriptionBots[j] = "";
            mtpBotSubscriptionBotIds[j] = 0;
            mtpBotRequestCounts[j] = 1;
            for (int i = 0; i < 14; i++) {
                mtpBotRequestArrays[j][i] = "";
                mtpBotProxyArrays[j][i] = "";
                mtpBotTimeLastRequestArrays[j][i] = 0L;
            }
        }
    }

    // Keep old fields for migration if needed, or remove if not necessary. 
    // Given the issue, we probably should migrate or at least support them.
    public static long mtproxySubscriptionChatId1 = 0; // channel chat ID (positive)
    public static String[] mtproxyRequest1Array = new String[14]; // MTProxy URLs
    public static int mtproxyRequestCount = 1;
    ...
    public static class ProxyInfo {
        ...
        public boolean isSame(ProxyInfo other) {
            if (other == null) return false;
            return TextUtils.equals(address, other.address) && port == other.port;
        }
    }
    ...
    public static void saveConfig() {
        synchronized (sync) {
            try {
                ...
                editor.putString("v2raySubscription1", v2raySubscription1);
                editor.putLong("v2raySubscriptionId1", v2raySubscriptionId1);
                // Save array-based storage
                editor.putInt("v2rayRequestCount", v2rayRequestCount);
                editor.putInt("timeBetwRequest2Bot", timeBetwRequest2Bot);
                editor.putInt("timeBetwRequest2BotMtp", timeBetwRequest2BotMtp);
                for (int i = 0; i < 14; i++) {
                    editor.putString("v2rayRequest1_" + i, v2rayRequest1Array[i]);
                    editor.putString("v2rayKey1_" + i, v2rayKey1Array[i]);
                    editor.putLong("v2rayTimeLastRequest_" + i, v2rayTimeLastRequestArray[i]);
                }

                // V2Ray subscriptions
                editor.putInt("v2raySubscriptionsCount", v2raySubscriptionsCount);
                for (int j = 0; j < 5; j++) {
                    editor.putString("v2raySubscriptionBot_" + j, v2raySubscriptionBots[j]);
                    editor.putLong("v2raySubscriptionBotId_" + j, v2raySubscriptionBotIds[j]);
                    editor.putInt("v2rayRequestCount_" + j, v2rayRequestCounts[j]);
                    for (int i = 0; i < 14; i++) {
                        editor.putString("v2rayRequest_" + j + "_" + i, v2rayRequestArrays[j][i] != null ? v2rayRequestArrays[j][i] : "");
                        editor.putString("v2rayKey_" + j + "_" + i, v2rayKeyArrays[j][i] != null ? v2rayKeyArrays[j][i] : "");
                        editor.putLong("v2rayTimeLastRequest_" + j + "_" + i, v2rayTimeLastRequestArrays[j][i]);
                    }
                }
                // Legacy fields for backward compatibility
                editor.putString("v2rayRequest1", v2rayRequest1);
                editor.putString("v2rayKey1", v2rayKey1);
                editor.putString("v2rayRequest11", v2rayRequest11);
                editor.putString("v2rayKey11", v2rayKey11);
                editor.putString("v2rayRequest12", v2rayRequest12);
                editor.putString("v2rayKey12", v2rayKey12);
                editor.putString("v2rayRequest13", v2rayRequest13);
                editor.putString("v2rayKey13", v2rayKey13);
                editor.putString("v2raySubscription2", v2raySubscription2);
                editor.putString("v2rayRequest2", v2rayRequest2);
                editor.putString("v2rayKey2", v2rayKey2);
                editor.putString("v2rayMinWorkingKeys", v2rayMinWorkingKeys);
                editor.putInt("autoMinWrkKeys", autoMinWrkKeys);
                editor.putInt("autoMinWrkMTProxy", autoMinWrkMTProxy);
                editor.putInt("autoTimeTstMinute", autoTimeTstMinute);
                // MTProxy subscriptions
                editor.putInt("mtproxySubscriptionsCount", mtproxySubscriptionsCount);
                for (int j = 0; j < 5; j++) {
                    editor.putLong("mtproxySubscriptionChatId_" + j, mtproxySubscriptionChatIds[j]);
                    editor.putInt("mtproxyRequestCount_" + j, mtproxyRequestCounts[j]);
                    for (int i = 0; i < 14; i++) {
                        editor.putString("mtproxyRequest_" + j + "_" + i, mtproxyRequestArrays[j][i] != null ? mtproxyRequestArrays[j][i] : "");
                    }
                }
                // MTProxy Bot subscriptions
                editor.putInt("mtpBotSubscriptionsCount", mtpBotSubscriptionsCount);
                for (int j = 0; j < 5; j++) {
                    editor.putString("mtpBotSubscriptionBot_" + j, mtpBotSubscriptionBots[j] != null ? mtpBotSubscriptionBots[j] : "");
                    editor.putLong("mtpBotSubscriptionBotId_" + j, mtpBotSubscriptionBotIds[j]);
                    editor.putInt("mtpBotRequestCount_" + j, mtpBotRequestCounts[j]);
                    for (int i = 0; i < 14; i++) {
                        editor.putString("mtpBotRequest_" + j + "_" + i, mtpBotRequestArrays[j][i] != null ? mtpBotRequestArrays[j][i] : "");
                        editor.putString("mtpBotProxy_" + j + "_" + i, mtpBotProxyArrays[j][i] != null ? mtpBotProxyArrays[j][i] : "");
                        editor.putLong("mtpBotTimeLastRequest_" + j + "_" + i, mtpBotTimeLastRequestArrays[j][i]);
                    }
                }
    ...
    public static void loadConfig() {
        synchronized (sync) {
            ...
            v2raySubscription1 = preferences.getString("v2raySubscription1", "");
            v2raySubscriptionId1 = preferences.getLong("v2raySubscriptionId1", 0L);
            v2rayRequestCount = preferences.getInt("v2rayRequestCount", 1);
            timeBetwRequest2Bot    = preferences.getInt("timeBetwRequest2Bot", 360);
            timeBetwRequest2BotMtp = preferences.getInt("timeBetwRequest2BotMtp", 360);
            for (int i = 0; i < 14; i++) {
                v2rayRequest1Array[i] = preferences.getString("v2rayRequest1_" + i, "");
                v2rayKey1Array[i] = preferences.getString("v2rayKey1_" + i, "");
                v2rayTimeLastRequestArray[i] = preferences.getLong("v2rayTimeLastRequest_" + i, 0L);
            }

            v2raySubscriptionsCount = preferences.getInt("v2raySubscriptionsCount", 0);
            for (int j = 0; j < 5; j++) {
                v2raySubscriptionBots[j] = preferences.getString("v2raySubscriptionBot_" + j, "");
                v2raySubscriptionBotIds[j] = preferences.getLong("v2raySubscriptionBotId_" + j, 0L);
                v2rayRequestCounts[j] = preferences.getInt("v2rayRequestCount_" + j, 1);
                for (int i = 0; i < 14; i++) {
                    v2rayRequestArrays[j][i] = preferences.getString("v2rayRequest_" + j + "_" + i, "");
                    v2rayKeyArrays[j][i] = preferences.getString("v2rayKey_" + j + "_" + i, "");
                    v2rayTimeLastRequestArrays[j][i] = preferences.getLong("v2rayTimeLastRequest_" + j + "_" + i, 0L);
                }
            }
            // Migration for v2ray
            if (v2raySubscriptionsCount == 0 && !TextUtils.isEmpty(v2raySubscription1)) {
                v2raySubscriptionsCount = 1;
                v2raySubscriptionBots[0] = v2raySubscription1;
                v2raySubscriptionBotIds[0] = v2raySubscriptionId1;
                v2rayRequestCounts[0] = v2rayRequestCount;
                for (int i = 0; i < 14; i++) {
                    v2rayRequestArrays[0][i] = v2rayRequest1Array[i];
                    v2rayKeyArrays[0][i] = v2rayKey1Array[i];
                    v2rayTimeLastRequestArrays[0][i] = v2rayTimeLastRequestArray[i];
                }
            }
            // Legacy fields for backward compatibility
            v2rayRequest1 = preferences.getString("v2rayRequest1", "");
            v2rayKey1 = preferences.getString("v2rayKey1", "");
            v2rayRequest11 = preferences.getString("v2rayRequest11", "");
            v2rayKey11 = preferences.getString("v2rayKey11", "");
            v2rayRequest12 = preferences.getString("v2rayRequest12", "");
            v2rayKey12 = preferences.getString("v2rayKey12", "");
            v2rayRequest13 = preferences.getString("v2rayRequest13", "");
            v2rayKey13 = preferences.getString("v2rayKey13", "");
            
            // Migrate legacy fields to array if array is empty (first launch after update)
            if (v2rayRequestCount == 1 && v2rayRequest1Array[0].isEmpty()) {
                v2rayRequest1Array[0] = v2rayRequest1;
                v2rayKey1Array[0] = v2rayKey1;
                v2rayRequest1Array[1] = v2rayRequest11;
                v2rayKey1Array[1] = v2rayKey11;
                v2rayRequest1Array[2] = v2rayRequest12;
                v2rayKey1Array[2] = v2rayKey12;
                v2rayRequest1Array[3] = v2rayRequest13;
                v2rayKey1Array[3] = v2rayKey13;
                // Update count based on which fields were filled
                int newCount = 1;
                for (int i = 1; i < 4; i++) {
                    if (!v2rayRequest1Array[i].isEmpty()) {
                        newCount = i + 1;
                    }
                }
                v2rayRequestCount = newCount;
            }
            
            v2raySubscription2 = preferences.getString("v2raySubscription2", "");
            v2rayRequest2 = preferences.getString("v2rayRequest2", "");
            v2rayKey2 = preferences.getString("v2rayKey2", "");
            v2rayMinWorkingKeys = preferences.getString("v2rayMinWorkingKeys", "");
            autoMinWrkKeys = preferences.getInt("autoMinWrkKeys", 1);
            autoMinWrkMTProxy = preferences.getInt("autoMinWrkMTProxy", 1);
            autoTimeTstMinute = preferences.getInt("autoTimeTstMinute", 5);
            // MTProxy subscriptions
            mtproxySubscriptionsCount = preferences.getInt("mtproxySubscriptionsCount", 0);
            for (int j = 0; j < 5; j++) {
                mtproxySubscriptionChatIds[j] = preferences.getLong("mtproxySubscriptionChatId_" + j, 0);
                mtproxyRequestCounts[j] = preferences.getInt("mtproxyRequestCount_" + j, 1);
                for (int i = 0; i < 14; i++) {
                    mtproxyRequestArrays[j][i] = preferences.getString("mtproxyRequest_" + j + "_" + i, "");
                }
            }

            // MTProxy subscription 1 (legacy)
            mtproxySubscriptionChatId1 = preferences.getLong("mtproxySubscriptionChatId1", 0);
            mtproxyRequestCount = preferences.getInt("mtproxyRequestCount", 1);
            for (int i = 0; i < 14; i++) {
                mtproxyRequest1Array[i] = preferences.getString("mtproxyRequest1_" + i, "");
            }

            // Migration from legacy to array if needed
            if (mtproxySubscriptionsCount == 0 && mtproxySubscriptionChatId1 != 0) {
                mtproxySubscriptionsCount = 1;
                mtproxySubscriptionChatIds[0] = mtproxySubscriptionChatId1;
                mtproxyRequestCounts[0] = mtproxyRequestCount;
                for (int i = 0; i < 14; i++) {
                    mtproxyRequestArrays[0][i] = mtproxyRequest1Array[i];
                }
            }
            // MTProxy Bot subscriptions
            mtpBotSubscriptionsCount = preferences.getInt("mtpBotSubscriptionsCount", 0);
            for (int j = 0; j < 5; j++) {
                mtpBotSubscriptionBots[j] = preferences.getString("mtpBotSubscriptionBot_" + j, "");
                mtpBotSubscriptionBotIds[j] = preferences.getLong("mtpBotSubscriptionBotId_" + j, 0);
                mtpBotRequestCounts[j] = preferences.getInt("mtpBotRequestCount_" + j, 1);
                for (int i = 0; i < 14; i++) {
                    mtpBotRequestArrays[j][i] = preferences.getString("mtpBotRequest_" + j + "_" + i, "");
                    mtpBotProxyArrays[j][i] = preferences.getString("mtpBotProxy_" + j + "_" + i, "");
                    mtpBotTimeLastRequestArrays[j][i] = preferences.getLong("mtpBotTimeLastRequest_" + j + "_" + i, 0L);
                }
            }
