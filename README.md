...
форком NekoX =Telegram). Запускается как отдельное приложение из модуля v2ray.

При затруднении соединений Telegram (и ютуп, и др.и заруб.сайтов) ПРИ РАБОТАЮЩЕМ ИНТЕРНЕТЕ польз-ль
жмет кн. авто-обновления ....которая запускает цикл,  ф-ции в котором действовуют по след. общей логике:
...
В панели настроек Telegram, на 3ем сверху п.меню "Код-пароль" создайте пароль, и, после ввода 
код-пароля, и тапа кнопки "V2ray MTProxy auti upd." вы входите в панель упр-я. См. по ней
[инструкцию](https://github.com/vit1967/TeleRay/blob/master/docs/V2RAY_SUBSCRIPTION_USER_GUIDE.md)

## From NekoX
(оставил без изменений, так как функциональность взятого за оснву NekoX не менял)
...
[//]: # (Android Studio 3.4, Android NDK rev. 20 and Android SDK 8.1)
[//]: # ()
