...
Если у вас нет подписки(как правило платной) на vless,vmeess,trojan и др. кл.-профили для v2ray приложений, вы все равно сможете в этом Telegram-клиенте автоматизировать обновление и кэшироввание(резервирование, запасение резервных) MTProxy во время коннекта Telegram с интернетом, и, соответственно восстановление коннекта, когда MTProxy в proxyList Telegram "сгорят"(заблокируются).
...
и v2rayTg, то он просто жмет кн. запуска полного цикла авто-обновления Кл.профилей и MTProxy, либо кн. запуска обновления только MTProxy,  которая запускает соответствующий цикл, ф-ции в котором действовуют по след. общей логике:
...
настройкой этого нового кл-та Telegram, сначала войдите в свой старый клиент (на этом или др. уcтр-ве) и найдите 
...
Если вы нашли баг или у вас есть идея, пожалуйста, создайте [Issue](https://github.com/vit1967/TeleRay/issues)
